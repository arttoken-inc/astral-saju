      ...
      <main className="pt-[3.75rem]">
        <div className="bg-[#F3F2EF]">
          ...
          <div className="relative">
            ...
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "36%", left: "50%", transform: "translateX(-50%)" }}>
              {n}님,<br />만나서 반가워요,
            </p>
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "47%", left: "50%", transform: "translateX(-50%)" }}>
              지금부터 {n}님의<br />사주를 풀어드릴<br />청월이라고 합니다.
            </p>
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "84%", left: "50%", transform: "translateX(-50%)" }}>
              {n}님과 제가<br />이렇게 인연이 닿아
            </p>
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "89%", left: "50%", transform: "translateX(-50%)" }}>
          ...
          <div className="relative">
            ...
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "70%", left: "50%", transform: "translateX(-50%)" }}>
          ...
          <div className="relative">
            ...
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "35%", left: "50%", transform: "translateX(-50%)" }}>
              조금 비밀스러운<br />이야기지만,
            </p>
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "70%", left: "50%", transform: "translateX(-50%)" }}>
          ...
          <div className="relative">
            ...
            <p className="absolute whitespace-nowrap text-center text-lg font-gapyeong text-[#111111]" style={{ top: "60%", left: "50%", transform: "translateX(-50%)" }}>
